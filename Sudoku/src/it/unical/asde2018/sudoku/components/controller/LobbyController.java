...
public class LobbyController {
	...
	public String createRoom(@RequestParam String lobbyName, @RequestParam String difficulty, HttpSession session) {
		...
		if (session.getAttribute("sudoku") == null) {
			...
			String sudokuToSolve = sudokuGeneratorService.getSudokuByDifficulty(Difficulty.valueOf(difficulty));
			lobbyService.getMatches().get(id_room).setSudokuToSolve(sudokuToSolve);
	...
	public String joinRoom(@RequestParam String room, /* @RequestParam String difficulty, */ HttpSession session) {
